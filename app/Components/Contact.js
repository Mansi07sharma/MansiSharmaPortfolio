...
export const Contact = () => {
    const contactInfo = [
        ...
        },
        {
            icon: Linkedin,
            label: "LinkedIn",
            value: "linkedin/mansi-sharma",
            link: "https://linkedin.com/mansi-sharma",
            color: "from-blue-600 to-blue-800"
        },
        {
            icon: Github,
            label: "GitHub",
            value: "github/Mansi07sharma",
                            ...
                            >
                                <div className="flex items-center space-x-4">
                                    <div className={`sm:p-3 p-2 rounded-lg bg-gradient-to-r ${contact.color} group-hover:scale-110 transition-transform duration-300`}>
                                        <contact.icon className="text-white sm:h-7 sm:w-7 h-4 w-4"  />
                                    </div>
                                    <div>
                                        <h3 className="sm:text-lg text-sm font-semibold text-white mb-1">{contact.label}</h3>
                                        <p className="text-gray-400 sm:text-lg text-sm group-hover:text-gray-300 transition-colors">{contact.value}</p>
                                    </div>
                                </div>
                            </a>
                        ))}
                    ...
                    <div className="mt-12 text-center">
                        ...
                        <div className="border-t border-gray-800 pt-8 sm:text-lg text-xs">
                            <p className="text-gray-500">
                                © 2025 Mansi Sharma. Built with Next.js and Tailwind CSS.
                            </p>
                        </div>
                    </div>
                </div>
